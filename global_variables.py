...
stream_quality = 'Max' # The stream quality selected from the combolist (default Max).
file_save_location = '' # Location of file path.Changes when using the file save selector.
conversion_records = 'conversion_history.csv' # CSV File for conversion records. Must be local directory.
